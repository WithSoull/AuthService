...
Микросервис аутентификации и авторизации для [мессенджера](https://github.com/WithSoull/messenger-overview). Отвечает за управление JWT токенами, валидацию учетных данных и контроль попыток входа.
